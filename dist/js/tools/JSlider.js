...
class JSlider extends JappN {
    ...
    alCargar(props, cont) {
        ...
        return React.createElement("div", { id: props.id, class: "JSlider " + props.class, style: "height:" + props.height },
            React.createElement("div", { class: "wrapper " + props.wClass, style: "height:" + props.height },
                this.getDivs(cont, props.tipo),
                props.res.map(i => i.tagName == "DIV" ? i : React.createElement("div", { class: props.iClass }, i))));
    }
    alCargado(el) {
        ...
        function dragMove(e) {
            ...
            if (Math.abs(currentPos - startPos) > 20)
                click = false;
