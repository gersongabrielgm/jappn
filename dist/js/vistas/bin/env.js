...
export const preload = "./js/vistas/bin/preload.gif"; //ruta absolutam en caso de ser vacia se usa preload por defecto
...
export const runLevel = 1; //0:en linea 1:local 2:mixto. nivel de ejecucion por defecto en peticiones rest
//valores por defecto para contruccion del conector rest
export const restDefault = {
    superReq: true
};
//sockets para webRTC P2P - pc1-----pc2
//export const nsockets=["socket1", "socket2", "socket3", "Jesus"]
export const nsockets = [];
//Mi socket, 
export const miSocket = null;
